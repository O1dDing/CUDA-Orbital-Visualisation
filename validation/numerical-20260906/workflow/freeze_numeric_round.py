...
manifest={'schema':2,'name':args.round_id+'-'+args.kind,'kind':args.kind,'git_commit':commit,'runner_source_commit':runner_commit,
    ...
    'resources':{'workers':1 if args.kind=='pilot' else 4,'threads_per_worker':3,
                 'memory_gib_per_worker':24,'aggregate_cpu_cores':12,'aggregate_memory_gib':128},
    ...
    'not_a_final_acceptance':['REF-001 physical conclusions paused','remaining known product issues still open',
